// Enhanced by AI on 2025-08-07T20:18:12.072Z
// Section: navigation
// Category: navigation
...
import { Menu, X, ArrowRight, Code, Database, Server, Headphones } from "lucide-react"
import { cn } from "@/lib/utils"

export default function Navbar() {
  const [isOpen, setIsOpen] = useState(false)

  // Updated navigation to match the actual page structure for an IT freelance landing page
  const navigation = [
    { name: "Home", href: "/" },
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center space-x-2">
              <div className="size-8 rounded-lg bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center">
                <Code className="text-primary-foreground size-4" />
              </div>
